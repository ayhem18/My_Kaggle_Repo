...
from face.helper_functions import build_classes_paths, process_save_path
...
def build_embeddings(images: Sequence[Union[Path, str, np.ndarray, torch.tensor]],
    ...
    if not isinstance(face_images, torch.Tensor):
        # make sure to input a tensor to the encoder
